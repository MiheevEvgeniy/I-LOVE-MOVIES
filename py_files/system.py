...
class Systems(UI):
    ...
    def searching_sys(self):
        ...
        self.srch_b.setIcon(QIcon('C:\\Users\\User\\Desktop\\pythonProject\\textures\\search.svg'))
    ...
    def menu_bar(self):
        ...
        # Exit action
        self.exit_action = QAction(QIcon('C:\\Users\\User\\Desktop\\pythonProject\\textures\\exit.svg'), '&Exit', self)
        self.exit_action.setShortcut('Ctrl+Q')
        self.exit_action.setStatusTip('Exit application')

        # Save action
        self.save_action = QAction(QIcon('C:\\Users\\User\\Desktop\\pythonProject\\textures\\save.svg'), '&Save', self)
        self.save_action.setShortcut('Ctrl+S')
        self.save_action.setStatusTip('Save all data')

        # Info action
        self.info_action = QAction(QIcon('C:\\Users\\User\\Desktop\\pythonProject\\textures\\info.svg'), '&Info', self)
        self.info_action.setShortcut('Ctrl+I')
        self.info_action.setStatusTip('Show information about program')

        # Settings action
        self.settings_action = QAction(QIcon('C:\\Users\\User\\Desktop\\pythonProject\\textures\\settings.svg'), '&Settings', self)
    ...
    def settings_menu(self):
        ...
        self.st_menu.setWindowIcon(QIcon('C:\\Users\\User\\Desktop\\pythonProject\\textures\\settings.svg'))
        ...
        self.cr.create_button(self.color_btn, 250, 250, 50, 50, 16)
        ...
        def pick_color_menu():
            ...
            self.edit_color_plate = QPushButton(self.pcm)
            self.cr.create_button(self.edit_color_plate, 10, 80, 320, 30, 12)
            ...
            def color_set(red, green, blue):
                if str(red).isdigit() == True \
                    ...
                    pal = QPalette()
                    role = QPalette.Base
                    pal.setColor(role, QColor(int(red), int(green), int(blue)).toRgb())
    ...
    def info_win(self):
        ...
        self.reply.setWindowIcon(QIcon('C:\\Users\\User\\Desktop\\pythonProject\\textures\\info.svg'))
        ...
        f = open('C:\\Users\\User\\Desktop\\pythonProject\\data\\Info.txt', 'r')
        text = ''
        for i in f:
            text += i
        # Adding this rows
